...
{
    public partial class AulaSP1 : Form
    {
        ...
        private int idAula = 12;//Recordar poner esto en todas las aulas
        ...
        private void AulaSP1_Load(object sender, EventArgs e)
        {
